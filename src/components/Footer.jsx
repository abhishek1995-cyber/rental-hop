    ...
    return (
        ...
        <section>
			<footer className=" bg-dark-purple text-white" >
				<div className="bg-dark-purple text-whitep-0">
						...
						<div className="row">
							<div className="col-xl-3 col-lg-6 col-md-12">
								...
								<ul className="social-icons mb-0 mt-3">
									<li>
										<a className="social-icon" href=""><i className="fa fa-facebook text-white-50"></i></a>
									</li>
									<li>
										<a className="social-icon" href=""><i className="fa fa-twitter text-white-50"></i></a>
									</li>
									<li>
										<a className="social-icon" href=""><i className="fa fa-rss text-white-50"></i></a>
									</li>
									<li>
										<a className="social-icon" href=""><i className="fa fa-youtube text-white-50"></i></a>
									</li>
									<li>
										<a className="social-icon" href=""><i className="fa fa-linkedin text-white-50"></i></a>
									</li>
								</ul>
							</div>
