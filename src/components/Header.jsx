          ...
          <div className="container flex">
            ...
            <ul className="contact">
              <li className="dropdown">
                <a href="" className="text-white" data-bs-toggle="dropdown">
                  <span>
                    {" "}
                    En <i className="fe fe-chevron-down fs-13 text-muted"></i>
                  </span>{" "}
                </a>
              ...
              <li className="dropdown">
                <a href="" className="text-white" data-bs-toggle="dropdown">
                  <span>
                    Cur <i className="fe fe-chevron-down fs-13 text-muted"></i>
                  </span>
                </a>
                <div className="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                  <a className="dropdown-item" href="">
        ...
        <div className="horizontal-header ">
          <div className="container">
            <div className="d-flex p-3">
              <img
                src="/assets/images/brand/logo.gif"
                alt=""
                width="130px"
                className=""
              />
                ...
                <ul className="horizontalMenu-list account-login">
                  <li className="dropdown bordered">
                    ...
                    >
                      <span>
                        {" "}
                        Account <i className="fe fe-chevron-down fs-13 "></i>
                      </span>{" "}
                    </a>
                    <div className="dropdown-menu dropdown-menu-end dropdown-menu-arrow ">
                      <a href="" className="dropdown-item">
